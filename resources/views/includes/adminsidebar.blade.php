<div id="sidebar" class="show hidden sm:block col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-1 bg-red-500 text-white rounded-lg overflow-y-auto">
    ...
    <div class="overflow-hidden shadow-sm">
        <div class="p-6">
            ...
            <ul class="space-y-2">
                ...
                <!-- Example: All Payment History -->
                <li>
                    <a href="{{ route('all.payment.history') }}" class="flex items-center px-4 py-2 hover:bg-red-700 rounded-lg" data-has-submenu="false">
