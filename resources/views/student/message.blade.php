                                    ...
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="top-contacts-box">
                                                    <div class="profile-img online">
                                                        <a href="#"><img src="{{asset('assets/img/user/user12.jpg')}}" alt="Image"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="top-contacts-box">
                                                    <div class="profile-img online">
                                                        <a href="#"><img src="{{asset('assets/img/user/user2.jpg')}}" alt="Image"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="top-contacts-box">
                                                    <div class="profile-img online">
                                                        <a href="#"><img src="{{asset('assets/img/user/user3.jpg')}}" alt="Image"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="top-contacts-box">
                                                    <div class="profile-img online">
                                                        <a href="#"><img src="{{asset('assets/img/user/user5.jpg')}}" alt="Image"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="top-contacts-box">
                                                    <div class="profile-img online">
                                                        <a href="#"><img src="{{asset('assets/img/user/user6.jpg')}}" alt="Image"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="sidebar-body chat-body" id="chatsidebar">
                                    ...
                                    <ul class="user-list space-chat">
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" class="status-active">
                                                <div class="avatar avatar-online">
                                                    <img src="{{asset('assets/img/user/user12.jpg')}}" class="rounded-circle" alt="image">
                                                </div>
                                        ...
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div>
                                                    <div class="avatar ">
                                                        <img src="{{asset('assets/img/user/user5.jpg')}}" class="rounded-circle" alt="image">
                                                    </div>
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                        ...
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div class="avatar avatar-online">
                                                    <img src="{{asset('assets/img/user/user3.jpg')}}" class="rounded-circle" alt="image">
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                    ...
                                    <ul class="user-list">
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div class="avatar avatar-online">
                                                    <img src="{{asset('assets/img/user/user11.jpg')}}" class="rounded-circle" alt="image">
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                                        <h5>Horace Keene</h5>
                                        ...
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div>
                                                    <div class="avatar avatar-online">
                                                        <img src="{{asset('assets/img/user/user4.jpg')}}" class="rounded-circle" alt="image">
                                                    </div>
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                        ...
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div class="avatar">
                                                    <img src="{{asset('assets/img/user/user.jpg')}}" class="rounded-circle" alt="image">
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                                        <h5>James Albert</h5>
                                        ...
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div>
                                                    <div class="avatar avatar-online">
                                                        <img src="{{asset('assets/img/user/user6.jpg')}}" class="rounded-circle" alt="image">
                                                    </div>
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                        ...
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div>
                                                    <div class="avatar ">
                                                        <img src="{{asset('assets/img/user/user1.jpg')}}" class="rounded-circle" alt="image">
                                                    </div>
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                        ...
                                        <li class="user-list-item chat-user-list">
                                            <a href="javascript:void(0);" >
                                                <div>
                                                    <div class="avatar avatar-online">
                                                        <img src="{{asset('assets/img/user/user13.jpg')}}" class="rounded-circle" alt="image">
                                                    </div>
                                                </div>
                                                <div class="users-list-body">
                                                    <div>
                                ...
                                <div class="messages">
                                    <div class="chats">
                                        <div class="chat-avatar">
                                            <img src="{{asset('assets/img/user/user12.jpg')}}" class="rounded-circle dreams_chat" alt="image">
                                        </div>
                                    ...
                                    <div class="chats chats-right">
                                        <div class="chat-content">
                                            ...
                                            <div class="message-content ">
                                                <div class="chat-voice-group">
                                                    <ul>
                                                        <li><a href="javascript:void(0);"><span><img src="{{asset('assets/img/icon/play-01.svg')}}" alt="image"></span></a></li>
                                                        <li><img src="{{asset('assets/img/icon/voice.svg')}}" class="img-fluid" alt="image"></li>
                                                        <li>0:05</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="chat-avatar">
                                            <img src="{{asset('assets/img/user/user2.jpg')}}" class="rounded-circle dreams_chat" alt="image">
                                        </div>
                                    </div>
                                    <div class="chats">
                                        <div class="chat-avatar">
                                        ...
                                        <div class="chat-content">
                                            ...
                                            <div class="message-content award-link chat-award-link">
                                                ...
                                                <img src="{{asset('assets/img/chat-img-01.jpg')}}" class="img-fluid" alt="img">										  </div>
                                        </div>
                                    </div>
                                    <div class="chats chats-right">
                                        <div class="chat-content">
                                    ...
                                    <div class="chats">
                                        ...
                                        <div class="chat-content">
                                            ...
                                            <div class="like-chat-grp">
                                                <ul>
                                                    <li class="like-chat"><a href="javascript:void(0);">2<img src="{{asset('assets/img/icon/like.svg')}}"  alt="Icon"></a></li>
                                                    <li class="comment-chat"><a href="javascript:void(0);">2<img src="{{asset('assets/img/icon/heart.svg')}}"  alt="Icon"></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form>
                                ...
                                <div class="replay-forms">
                                    <div class="chats forward-chat-msg reply-div d-none">
                                        ...
                                        <div class="chat-avatar">
                                            <img src="{{asset('assets/img/user/user3.jpg')}}" class="rounded-circle dreams_chat" alt="image">
                                        </div>
                                        <div class="chat-content">
                                            <div class="chat-profile-name">
