                    ...
                    <div class="breadcrumb-list pt-5">
                        ...
                        <nav aria-label="breadcrumb" class="page-breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item " ><a href="{{ route('blog.view') }}"></a>Blog</li>
						...
						<div class="col-lg-9 col-md-12">
							...
							<div class="blog">
								<div class="blog-image">
									 <img class="img-fluid" src="{{ url('storag/'.$blog->image) }}" alt="Post Image">
								</div>
								<div class="blog-info clearfix">
									<div class="post-left">
										<ul>
											...
											<li><img class="img-fluid" src="assets/img/icon/icon-22.svg" alt="Img">{{ $blog->published_at->diffForHumans() }}</li>
											<li><img class="img-fluid" src="assets/img/icon/icon-23.svg" alt="Img">{{ $blog->blogCategory->title }}</li>
										</ul>
									</div>
								</div>
