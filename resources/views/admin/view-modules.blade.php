                        ...
                        <div class="overflow-x-auto bg-white rounded-lg shadow-md">
                            <table class="min-w-full bg-white">
                                <thead class="bg-red-800 text-white text-left">
                                    <tr>
                                        <th class="w-1/5 py-3 px-4 uppercase font-semibold text-sm">Module</th>
                                    ...
                                    @foreach ($modules as $module)
                                        <tr class="hover:bg-gray-200">
                                            ...
                                            <td class="py-3 px-4 flex space-x-2 whitespace-nowrap">
                                                <a href="{{ route('add.lesson', $module->id) }}" class="bg-orange-500 hover:bg-orange-700 text-white font-light py-2 px-4 rounded">Add Lesson</a>
                                                ...
                                                <a href="{{ route('lesson.course.module', $module->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-light py-2 px-4 rounded">View Lessons</a>
                                            </td>
