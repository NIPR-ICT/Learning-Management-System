                        ...
                        <div class="p-6 text-gray-900">
                            <form action="{{ route('lesson.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="course_name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm sm:text-sm" value="{{ $module->course->title }}" readonly>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" id="module_name" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm sm:text-sm" value="{{ $module->title }}" readonly>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" id="order" name="order" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm sm:text-sm" value="{{ old('order') }}">
                                    <x-input-error :messages="$errors->get('order')" class="mt-2" />
                                </div>

                                <div class="mb-4">
                                    <label for="content" class="block text-sm font-medium text-gray-700">Enter Lesson Content</label>
                                    <textarea id="content" name="content" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm sm:text-sm">{{ old('content') }}</textarea>
