    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary">List of Categories</button>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('category.edit.store', $category->id) }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control w-100 form-control-lg mb-3" name="bg_color" type="color"
                                        value="{{ old('bg_color', $category->bg_color) }}"
                                        aria-label=".form-control-lg example">
