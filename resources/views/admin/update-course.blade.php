                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900">
                            <form action="{{ route('course.update', $course->id) }}" method="POST">
                                ...
                                @method('PUT')
                                <div class="mb-4">
                                    <label for="title" class="block text-sm font-medium text-gray-700">Course
                                        Title</label>
                                ...
                                <div class="mb-4">
                                    <label for="part_id" class="block text-sm font-medium text-gray-700">Part Name with
                                        Program</label>
                                    <select id="part_id" name="part_id"
                                        ...
                                        @foreach ($parts as $part)
                                            <option value="{{ $part->id }}"
                                                data-program="{{ $part->program->title }}"
                                ...
                                <div class="mb-4">
                                    <label for="program_id" class="block text-sm font-medium text-gray-700">Confirm
                                        Program</label>
                                ...
                                <div class="mb-4">
                                    <label for="course_category" class="block text-sm font-medium text-gray-700">Course
                                        Category</label>
                                ...
                                <div class="mb-4">
                                    <label for="course_amount" class="block text-sm font-medium text-gray-700">Course
                                        Amount</label>
                                ...
                                <div class="mb-4">
                                    <label for="course_code" class="block text-sm font-medium text-gray-700">Enter
                                        Course Code</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea id="description" name="description" rows="4"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm sm:text-sm" style="resize: none">{{ old('description', $course->description) }}</textarea>
                                    <x-input-error :messages="$errors->get('description')" class="mt-2" />
                                </div>

                                <div class="mb-4">
                                    <label for="credit_unit" class="block text-sm font-medium text-gray-700">Course
                                        Credit Unit</label>
                                    <input type="number" min="0" id="credit_unit" name="credit_unit"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm sm:text-sm"
                                ...
                                <div class="mb-4">
                                    <label for="featured"
                                        class="block text-sm font-medium text-gray-700">Featured</label>
                                ...
                                <div>
                                    <button type="submit"
                                        class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                        Update
                                    </button>
                                </div>
                            </form>
