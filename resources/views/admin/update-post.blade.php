    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <a href="{{ route('all.post') }}" class="btn btn-primary">List of Posts</a>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
                ...
                <div class="col-8">
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <hr />
                            <form action="{{ route('post.edit.store', $post->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                                <label for="title" class="form-label">Post Title </label>
                                <input value="{{ old('title', $post->title) }}" class="form-control w-100 form-control-lg mb-3"
                                ...
                                <textarea class="form-control w-100 form-control-lg mb-3" id="body" name="body" rows="4"
                                    style="resize: none" aria-label=".form-control-lg example">{{ old('body', $post->body) }}</textarea>
                ...
                <div class="col-4">
                    <div class="card ">
                        <div class="card-body">
                            ...
                            <input value="{{ old('published_at', $post->published_at) }}" 
                                class="form-control w-100 form-control-lg mb-3"
